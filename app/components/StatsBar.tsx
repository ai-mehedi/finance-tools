const STATS = [
  { value: "200+", label: "Financial Tools", icon: "tools" },
  { value: "2M+", label: "Calculations Done", icon: "gear" },
  { value: "150K+", label: "Happy Users", icon: "users" },
  { value: "500+", label: "Expert Articles", icon: "article" },
...
export default function StatsBar() {
  return (
    <section className="w-full bg-gradient-to-r from-orange-400 to-orange-600">
          ...
          {STATS.map((s) => (
            <div key={s.label} className="flex items-center justify-center gap-3 text-white">
              ...
              <div className="leading-tight">
                ...
                <p className="text-xs text-white/85 sm:text-sm">{s.label}</p>
              </div>
            </div>
          ))}
        </div>
