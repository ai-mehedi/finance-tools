...
const baseMetadata: Metadata = {
  ...
  openGraph: { type: "website", url: PATH, title: "Latte Factor Calculator | TopicDrill", description: DESC },
  twitter: { card: "summary", title: "Latte Factor Calculator | TopicDrill", description: DESC },
};
