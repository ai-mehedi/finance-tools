...
export const metadata: Metadata = {
  ...
  openGraph: { type: "website", url: PATH, title: "Future Cost Calculator | TopicDrill", description: DESC },
  twitter: { card: "summary", title: "Future Cost Calculator | TopicDrill", description: DESC },
};
