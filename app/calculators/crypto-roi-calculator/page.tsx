...
export const metadata: Metadata = {
  ...
  openGraph: { type: "website", url: PATH, title: "Crypto ROI Calculator | TopicDrill", description: DESC },
  twitter: { card: "summary", title: "Crypto ROI Calculator | TopicDrill", description: DESC },
};
