...
export default function LoanPayoffCalculator() {
  ...
  const [result, setResult] = useState<LoanPayoffResult | null>(() => compute(DEFAULTS));
  ...
  function onSubmit(e: React.FormEvent) {
    ...
    if (!r) {
      setError("Enter a positive balance and a monthly payment large enough to cover the monthly interest.");
      setResult(null);
      return;
    }
    setError(null);
