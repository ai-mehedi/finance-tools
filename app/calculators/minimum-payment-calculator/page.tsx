...
const baseMetadata: Metadata = {
  ...
  openGraph: { type: "website", url: PATH, title: "Minimum Payment Calculator | TopicDrill", description: DESC },
  twitter: { card: "summary", title: "Minimum Payment Calculator | TopicDrill", description: DESC },
};
