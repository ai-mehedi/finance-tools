...
const baseMetadata: Metadata = {
  ...
  openGraph: { type: "website", url: PATH, title: "Home Equity HELOC Calculator | TopicDrill", description: DESC },
  twitter: { card: "summary", title: "Home Equity HELOC Calculator | TopicDrill", description: DESC },
};
