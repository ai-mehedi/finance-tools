...
const baseMetadata: Metadata = {
  ...
  openGraph: { type: "website", url: PATH, title: "Loan Affordability Calculator | TopicDrill", description: DESC },
  twitter: { card: "summary", title: "Loan Affordability Calculator | TopicDrill", description: DESC },
};
