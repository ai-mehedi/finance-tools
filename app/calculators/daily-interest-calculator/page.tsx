...
export const metadata: Metadata = {
  ...
  openGraph: { type: "website", url: PATH, title: "Daily Interest Calculator | TopicDrill", description: DESC },
  twitter: { card: "summary", title: "Daily Interest Calculator | TopicDrill", description: DESC },
};
