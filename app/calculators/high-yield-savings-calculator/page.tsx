...
const baseMetadata: Metadata = {
  ...
  openGraph: { type: "website", url: PATH, title: "High Yield Savings Calculator | TopicDrill", description: DESC },
  twitter: { card: "summary", title: "High Yield Savings Calculator | TopicDrill", description: DESC },
};
