...
const baseMetadata: Metadata = {
  ...
  openGraph: { type: "website", url: PATH, title: "Dividend Yield Calculator | TopicDrill", description: DESC },
  twitter: { card: "summary", title: "Dividend Yield Calculator | TopicDrill", description: DESC },
};
