...
export const metadata: Metadata = {
  ...
  openGraph: { type: "website", url: PATH, title: "Forex Profit Calculator | TopicDrill", description: DESC },
  twitter: { card: "summary", title: "Forex Profit Calculator | TopicDrill", description: DESC },
};
