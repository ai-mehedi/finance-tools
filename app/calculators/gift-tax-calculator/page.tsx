...
export const metadata: Metadata = {
  ...
  openGraph: { type: "website", url: PATH, title: "Gift Tax Calculator | TopicDrill", description: DESC },
  twitter: { card: "summary", title: "Gift Tax Calculator | TopicDrill", description: DESC },
};
