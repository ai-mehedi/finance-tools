...
const baseMetadata: Metadata = {
  ...
  openGraph: { type: "website", url: PATH, title: "Lot Size Calculator | TopicDrill", description: DESC },
  twitter: { card: "summary", title: "Lot Size Calculator | TopicDrill", description: DESC },
};
