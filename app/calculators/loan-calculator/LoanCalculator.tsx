...
export default function LoanCalculator() {
  ...
  const error =
    result === null
      ? "Enter a loan amount above 0, a term above 0 years, and a rate of 0 or more."
      : null;
  ...
  return (
    <div className="space-y-6">
      ...
      {/* What-if: how the interest rate changes the monthly payment + total interest. */}
      {result && <RateScenarios form={form} />}
    </div>
  );
}

/** Sweeps the annual interest rate so the user sees how their monthly payment and
 *  total interest shift across common rates plus their own value. */
