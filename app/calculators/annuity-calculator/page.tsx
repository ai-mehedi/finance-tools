...
export const metadata: Metadata = {
  ...
  openGraph: { type: "website", url: PATH, title: "Annuity Calculator | TopicDrill", description: DESC },
  twitter: { card: "summary", title: "Annuity Calculator | TopicDrill", description: DESC },
};
