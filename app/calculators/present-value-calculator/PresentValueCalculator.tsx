...
export default function PresentValueCalculator() {
  ...
  const [result, setResult] = useState<PresentValueResult | null>(() => compute(DEFAULTS));
  ...
  function onSubmit(e: React.FormEvent) {
    ...
    if (!r) {
      setError("Enter a number of years greater than 0 and a non-negative discount rate.");
      setResult(null);
      return;
    }
    setError(null);
