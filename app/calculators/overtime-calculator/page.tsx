...
export const metadata: Metadata = {
  ...
  openGraph: { type: "website", url: PATH, title: "Overtime Pay Calculator | TopicDrill", description: DESC },
  twitter: { card: "summary", title: "Overtime Pay Calculator | TopicDrill", description: DESC },
};
