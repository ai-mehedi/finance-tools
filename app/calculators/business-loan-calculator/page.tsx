...
export const metadata: Metadata = {
  ...
  openGraph: { type: "website", url: PATH, title: "Business Loan Calculator | TopicDrill", description: DESC },
  twitter: { card: "summary", title: "Business Loan Calculator | TopicDrill", description: DESC },
};
