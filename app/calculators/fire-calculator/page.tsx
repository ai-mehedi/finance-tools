...
const baseMetadata: Metadata = {
  ...
  openGraph: { type: "website", url: PATH, title: "FIRE Calculator | TopicDrill", description: DESC },
  twitter: { card: "summary", title: "FIRE Calculator | TopicDrill", description: DESC },
};
