...
export const metadata: Metadata = {
  ...
  openGraph: { type: "website", url: PATH, title: "Certificate of Deposit Calculator | TopicDrill", description: DESC },
  twitter: { card: "summary", title: "Certificate of Deposit Calculator | TopicDrill", description: DESC },
};
