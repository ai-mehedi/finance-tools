...
export const metadata: Metadata = {
  ...
  openGraph: { type: "website", url: PATH, title: "Mortgage Affordability Calculator | TopicDrill", description: DESC },
  twitter: { card: "summary", title: "Mortgage Affordability Calculator | TopicDrill", description: DESC },
};
