...
export const metadata: Metadata = {
  ...
  openGraph: { type: "website", url: PATH, title: "Car Lease Calculator | TopicDrill", description: DESC },
  twitter: { card: "summary", title: "Car Lease Calculator | TopicDrill", description: DESC },
};
