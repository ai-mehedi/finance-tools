...
const baseMetadata: Metadata = {
  ...
  openGraph: { type: "website", url: PATH, title: "Capital Gains Calculator | TopicDrill", description: DESC },
  twitter: { card: "summary", title: "Capital Gains Calculator | TopicDrill", description: DESC },
};
