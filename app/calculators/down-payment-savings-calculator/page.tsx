...
export const metadata: Metadata = {
  ...
  openGraph: { type: "website", url: PATH, title: "Down Payment Savings Calculator | TopicDrill", description: DESC },
  twitter: { card: "summary", title: "Down Payment Savings Calculator | TopicDrill", description: DESC },
};
