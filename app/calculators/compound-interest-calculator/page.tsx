...
export const metadata: Metadata = {
  ...
  openGraph: { type: "website", url: PATH, title: "Compound Interest Calculator | TopicDrill", description: DESC },
  twitter: { card: "summary", title: "Compound Interest Calculator | TopicDrill", description: DESC },
};
