...
const baseMetadata: Metadata = {
  ...
  openGraph: { type: "website", url: PATH, siteName: "TopicDrill", title: "Cash Flow Calculator | TopicDrill", description: DESC, images: [{ url: "/og.png", width: 1200, height: 630 }] },
  twitter: { card: "summary_large_image", title: "Cash Flow Calculator | TopicDrill", description: DESC, images: ["/og.png"] },
};
