...
const baseMetadata: Metadata = {
  ...
  openGraph: { type: "website", url: PATH, title: "Closing Cost Calculator | TopicDrill", description: DESC },
  twitter: { card: "summary", title: "Closing Cost Calculator | TopicDrill", description: DESC },
};
