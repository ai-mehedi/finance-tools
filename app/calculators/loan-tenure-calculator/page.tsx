...
export const metadata: Metadata = {
  ...
  openGraph: { type: "website", url: PATH, title: "Loan Tenure Calculator | TopicDrill", description: DESC },
  twitter: { card: "summary", title: "Loan Tenure Calculator | TopicDrill", description: DESC },
};
