...
const baseMetadata: Metadata = {
  ...
  openGraph: { type: "website", url: PATH, title: "Exchange Rate Calculator | TopicDrill", description: DESC },
  twitter: { card: "summary", title: "Exchange Rate Calculator | TopicDrill", description: DESC },
};
