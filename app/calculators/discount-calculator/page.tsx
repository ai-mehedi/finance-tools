...
const baseMetadata: Metadata = {
  ...
  openGraph: { type: "website", url: PATH, title: "Discount Calculator | TopicDrill", description: DESC },
  twitter: { card: "summary", title: "Discount Calculator | TopicDrill", description: DESC },
};
