...
export const metadata: Metadata = {
  ...
  openGraph: { type: "website", url: PATH, title: "College Savings Calculator | TopicDrill", description: DESC },
  twitter: { card: "summary", title: "College Savings Calculator | TopicDrill", description: DESC },
};
