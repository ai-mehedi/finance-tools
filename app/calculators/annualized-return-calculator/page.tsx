...
export const metadata: Metadata = {
  ...
  openGraph: { type: "website", url: PATH, title: "Annualized Return Calculator | TopicDrill", description: DESC },
  twitter: { card: "summary", title: "Annualized Return Calculator | TopicDrill", description: DESC },
};
