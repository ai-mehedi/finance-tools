...
export const metadata: Metadata = {
  ...
  openGraph: { type: "website", url: PATH, title: "Total Cost of Ownership Calculator | TopicDrill", description: DESC },
  twitter: { card: "summary", title: "Total Cost of Ownership Calculator | TopicDrill", description: DESC },
};
