...
export const metadata: Metadata = {
  ...
  openGraph: { type: "website", url: PATH, title: "Markup Calculator | TopicDrill", description: DESC },
  twitter: { card: "summary", title: "Markup Calculator | TopicDrill", description: DESC },
};
