...
export default function CoastFireCalculator() {
  ...
  const [result, setResult] = useState<CoastFireResult | null>(() => compute(DEFAULTS));
  ...
  function onSubmit(e: React.FormEvent) {
    ...
    if (!r) {
      setError("Retirement age must be above your current age, with positive spending and withdrawal rate.");
      setResult(null);
      return;
    }
    setError(null);
