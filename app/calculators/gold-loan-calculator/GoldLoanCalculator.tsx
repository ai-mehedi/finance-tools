...
export default function GoldLoanCalculator() {
  ...
  const [result, setResult] = useState<GoldLoanResult | null>(() => compute(DEFAULTS));
  ...
  function onSubmit(e: React.FormEvent) {
    ...
    if (!r) {
      setError("Enter a positive weight, rate per gram, a valid LTV up to 100 and a tenure greater than 0.");
      setResult(null);
      return;
    }
    setError(null);
