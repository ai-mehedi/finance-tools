...
const baseMetadata: Metadata = {
  ...
  openGraph: { type: "website", url: PATH, title: "EBITDA Calculator | TopicDrill", description: DESC },
  twitter: { card: "summary", title: "EBITDA Calculator | TopicDrill", description: DESC },
};
