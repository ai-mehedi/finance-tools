...
const baseMetadata: Metadata = {
  ...
  openGraph: { type: "website", url: PATH, title: "Critical Illness Cover Calculator | TopicDrill", description: DESC },
  twitter: { card: "summary", title: "Critical Illness Cover Calculator | TopicDrill", description: DESC },
};
