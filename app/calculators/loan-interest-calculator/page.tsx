...
export const metadata: Metadata = {
  ...
  openGraph: { type: "website", url: PATH, title: "Loan Interest Calculator | TopicDrill", description: DESC },
  twitter: { card: "summary", title: "Loan Interest Calculator | TopicDrill", description: DESC },
};
