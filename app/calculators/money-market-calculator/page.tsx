...
const baseMetadata: Metadata = {
  ...
  openGraph: { type: "website", url: PATH, title: "Money Market Calculator | TopicDrill", description: DESC },
  twitter: { card: "summary", title: "Money Market Calculator | TopicDrill", description: DESC },
};
