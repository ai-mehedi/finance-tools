...
export const metadata: Metadata = {
  ...
  openGraph: { type: "website", url: PATH, title: "Lease vs Buy Calculator | TopicDrill", description: DESC },
  twitter: { card: "summary", title: "Lease vs Buy Calculator | TopicDrill", description: DESC },
};
