...
export const metadata: Metadata = {
  ...
  openGraph: { type: "website", url: PATH, title: "Options Profit Calculator | TopicDrill", description: DESC },
  twitter: { card: "summary", title: "Options Profit Calculator | TopicDrill", description: DESC },
};
