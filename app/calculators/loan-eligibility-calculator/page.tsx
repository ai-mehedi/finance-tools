...
export const metadata: Metadata = {
  ...
  openGraph: { type: "website", url: PATH, title: "Loan Eligibility Calculator | TopicDrill", description: DESC },
  twitter: { card: "summary", title: "Loan Eligibility Calculator | TopicDrill", description: DESC },
};
