...
const baseMetadata: Metadata = {
  ...
  openGraph: { type: "website", url: PATH, title: "Bonus Calculator | TopicDrill", description: DESC },
  twitter: { card: "summary", title: "Bonus Calculator | TopicDrill", description: DESC },
};
