...
export const metadata: Metadata = {
  ...
  openGraph: { type: "website", url: PATH, title: "Net Profit Calculator | TopicDrill", description: DESC },
  twitter: { card: "summary", title: "Net Profit Calculator | TopicDrill", description: DESC },
};
