...
const baseMetadata: Metadata = {
  ...
  openGraph: { type: "website", url: PATH, title: "Personal Loan Calculator | TopicDrill", description: DESC },
  twitter: { card: "summary", title: "Personal Loan Calculator | TopicDrill", description: DESC },
};
