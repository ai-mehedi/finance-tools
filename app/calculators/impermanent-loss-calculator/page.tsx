...
export const metadata: Metadata = {
  ...
  openGraph: { type: "website", url: PATH, title: "Impermanent Loss Calculator | TopicDrill", description: DESC },
  twitter: { card: "summary", title: "Impermanent Loss Calculator | TopicDrill", description: DESC },
};
