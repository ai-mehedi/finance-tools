...
export const metadata: Metadata = {
  ...
  openGraph: { type: "website", url: PATH, title: "Credit Builder Loan Calculator | TopicDrill", description: DESC },
  twitter: { card: "summary", title: "Credit Builder Loan Calculator | TopicDrill", description: DESC },
};
