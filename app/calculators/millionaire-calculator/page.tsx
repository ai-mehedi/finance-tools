...
export const metadata: Metadata = {
  ...
  openGraph: { type: "website", url: PATH, title: "Millionaire Savings Calculator | TopicDrill", description: DESC },
  twitter: { card: "summary", title: "Millionaire Savings Calculator | TopicDrill", description: DESC },
};
