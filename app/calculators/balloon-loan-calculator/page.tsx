...
const baseMetadata: Metadata = {
  ...
  openGraph: { type: "website", url: PATH, title: "Balloon Loan Calculator | TopicDrill", description: DESC },
  twitter: { card: "summary", title: "Balloon Loan Calculator | TopicDrill", description: DESC },
};
