...
const baseMetadata: Metadata = {
  ...
  openGraph: { type: "website", url: PATH, title: "Inflation Calculator | TopicDrill", description: DESC },
  twitter: { card: "summary", title: "Inflation Calculator | TopicDrill", description: DESC },
};
