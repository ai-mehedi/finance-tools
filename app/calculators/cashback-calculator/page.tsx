...
export const metadata: Metadata = {
  ...
  openGraph: { type: "website", url: PATH, title: "Cashback Rewards Calculator | TopicDrill", description: DESC },
  twitter: { card: "summary", title: "Cashback Rewards Calculator | TopicDrill", description: DESC },
};
