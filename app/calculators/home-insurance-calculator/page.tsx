...
const baseMetadata: Metadata = {
  ...
  openGraph: { type: "website", url: PATH, title: "Home Insurance Calculator | TopicDrill", description: DESC },
  twitter: { card: "summary", title: "Home Insurance Calculator | TopicDrill", description: DESC },
};
