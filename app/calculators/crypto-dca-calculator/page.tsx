...
export const metadata: Metadata = {
  ...
  openGraph: { type: "website", url: PATH, title: "Crypto DCA Calculator | TopicDrill", description: DESC },
  twitter: { card: "summary", title: "Crypto DCA Calculator | TopicDrill", description: DESC },
};
