...
export const metadata: Metadata = {
  ...
  openGraph: { type: "website", url: PATH, title: "52 Week Savings Calculator | TopicDrill", description: DESC },
  twitter: { card: "summary", title: "52 Week Savings Calculator | TopicDrill", description: DESC },
};
