...
export const metadata: Metadata = {
  ...
  openGraph: { type: "website", url: PATH, title: "Credit Card Interest Calculator | TopicDrill", description: DESC },
  twitter: { card: "summary", title: "Credit Card Interest Calculator | TopicDrill", description: DESC },
};
