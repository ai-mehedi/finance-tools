...
export const metadata: Metadata = {
  ...
  openGraph: { type: "website", url: PATH, title: "Percentage Change Calculator | TopicDrill", description: DESC },
  twitter: { card: "summary", title: "Percentage Change Calculator | TopicDrill", description: DESC },
};
