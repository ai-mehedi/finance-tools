...
export const metadata: Metadata = {
  ...
  openGraph: { type: "website", url: PATH, title: "Customer Lifetime Value Calculator | TopicDrill", description: DESC },
  twitter: { card: "summary", title: "Customer Lifetime Value Calculator | TopicDrill", description: DESC },
};
