...
const baseMetadata: Metadata = {
  ...
  openGraph: { type: "website", url: PATH, title: "Cost Per Mile Calculator | TopicDrill", description: DESC },
  twitter: { card: "summary", title: "Cost Per Mile Calculator | TopicDrill", description: DESC },
};
