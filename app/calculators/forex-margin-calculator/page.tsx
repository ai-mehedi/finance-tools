...
export const metadata: Metadata = {
  ...
  openGraph: { type: "website", url: PATH, title: "Forex Margin Calculator | TopicDrill", description: DESC },
  twitter: { card: "summary", title: "Forex Margin Calculator | TopicDrill", description: DESC },
};
