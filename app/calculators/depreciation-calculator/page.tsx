...
export const metadata: Metadata = {
  ...
  openGraph: { type: "website", url: PATH, title: "Depreciation Calculator | TopicDrill", description: DESC },
  twitter: { card: "summary", title: "Depreciation Calculator | TopicDrill", description: DESC },
};
