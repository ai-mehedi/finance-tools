...
export const metadata: Metadata = {
  ...
  openGraph: { type: "website", url: PATH, title: "CAGR Calculator | TopicDrill", description: DESC },
  twitter: { card: "summary", title: "CAGR Calculator | TopicDrill", description: DESC },
};
