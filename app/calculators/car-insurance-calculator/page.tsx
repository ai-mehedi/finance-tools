...
export const metadata: Metadata = {
  ...
  openGraph: { type: "website", url: PATH, title: "Car Insurance Calculator | TopicDrill", description: DESC },
  twitter: { card: "summary", title: "Car Insurance Calculator | TopicDrill", description: DESC },
};
