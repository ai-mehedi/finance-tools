...
const baseMetadata: Metadata = {
  ...
  openGraph: { type: "website", url: PATH, title: "Fixed Deposit Calculator | TopicDrill", description: DESC },
  twitter: { card: "summary", title: "Fixed Deposit Calculator | TopicDrill", description: DESC },
};
