...
export const metadata: Metadata = {
  ...
  openGraph: { type: "website", url: PATH, title: "Customer Acquisition Cost Calculator | TopicDrill", description: DESC },
  twitter: { card: "summary", title: "Customer Acquisition Cost Calculator | TopicDrill", description: DESC },
};
