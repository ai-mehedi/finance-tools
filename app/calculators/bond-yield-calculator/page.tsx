...
export const metadata: Metadata = {
  ...
  openGraph: { type: "website", url: PATH, title: "Bond Yield Calculator | TopicDrill", description: DESC },
  twitter: { card: "summary", title: "Bond Yield Calculator | TopicDrill", description: DESC },
};
