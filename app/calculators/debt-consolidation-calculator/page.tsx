...
export const metadata: Metadata = {
  ...
  openGraph: { type: "website", url: PATH, title: "Debt Consolidation Calculator | TopicDrill", description: DESC },
  twitter: { card: "summary", title: "Debt Consolidation Calculator | TopicDrill", description: DESC },
};
