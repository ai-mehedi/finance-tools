...
export default function TimeValueOfMoneyCalculator() {
  ...
  const [result, setResult] = useState<TvmResult | null>(() => compute(DEFAULTS));
  ...
  function onSubmit(e: React.FormEvent) {
    ...
    if (!r) {
      setError("Check your inputs: years and periods must be greater than 0, and the rate solve needs values that can be reached.");
      setResult(null);
      return;
    }
    setError(null);
